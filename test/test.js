...
function suite(proxy) {
    ...
    it('23. Before change, try to add a new string property, but returning false.', () => {
    ...
    it('24. Before change, try to modify string property value, but returning false.', () => {
        var callbackTriggered = false;
        ObservableSlim.observe(p, function (changes) {
            callbackTriggered = true;
        });
    ...
    it('25. Before change, try to delete a property, but returning false.', () => {
        var callbackTriggered = false;
        ObservableSlim.observe(p, function (changes) {
            callbackTriggered = true;
        });
